...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Founder, Captain, Mentor}{Aug 2016 -- Jun 2019}
      {FIRST Robotics}{}
      \resumeItemListStart
        \resumeItem{Founded and led a team of 40 to design a 135-lb robot in 6 weeks to achieve FRC objectives at UC Davis each year}
        \resumeItem{Created autonomous algorithms in Java and OpenCV to perform required tasks during gameplay}
        \resumeItem{Set up the organization's GSuite, Slack, and Github for efficient collaboration}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Other Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Target}{}
      \resumeItemListStart
        \resumeItem{Led a team of 140 to meet daily operational goals within a \$100MM location within the online fulfillment departments}
        ...
        \resumeItem{Realigned all fulfillment departments under a single leadership structure}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Drove a "guest first" mentality when engaging, directly increasing loyalty by 18\%}
      \resumeItemListEnd
